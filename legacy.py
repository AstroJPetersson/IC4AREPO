...
class IceTap:
	...
	def density_profile(self, pos):
		'''
		Density profile for the Milky Way-like galaxy model (Robin Tress). 
		'''
...
# -------------- Write IC-file
icetap = IceTap(path='/home/astro/jpeterss/ICETAP/ICs/', boxsize=40, ulength=3.08567758e18, umass=1.9891e33, uvel=1e5)
icetap.collapsing_sphere(Nx=20, Ny=20, Nz=20, N_sphere=10000, T_grid=1.0e4, T_sphere=1.0e2, rho_grid=1.477e-2, 
						 rho_sphere=7.385, R_sphere=10, J_sphere=np.array([0, 0, 3.241e2]),  Coord_sink=[20, 20, 20], 
						 Vel_sink=[0.0, 0.0, 0.0], M_sink=1e2, check=True)
